...
for (let i = 0; i < puntuaciones.length; i++) {
    ...
    sumaPuntuaciones = sumaPuntuaciones + puntuaciones[i];
}

// ¿Cómo obtengo la media de una suma ?
const promedioNatacion = sumaPuntuaciones / puntuaciones.length; // <-- MODIFICAR ASIGNACIÓN
